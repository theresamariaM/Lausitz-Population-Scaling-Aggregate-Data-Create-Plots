...
# 5 pct
result_5pct = calcAvgSpeedFor5pct(df_network, path_part1)
output_path_5pct = path_part1 + "Avg_Speed_per_RoadTypeAndHour_5pct.csv"
result_5pct.to_csv(output_path_5pct, index = False)

# 10pct 
result_10pct = calcAvgSpeedFor10pct(df_network, path_part1)
output_path_10pct = path_part1 + "Avg_Speed_per_RoadTypeAndHour_10pct.csv"
result_10pct.to_csv(output_path_10pct, index = False)
