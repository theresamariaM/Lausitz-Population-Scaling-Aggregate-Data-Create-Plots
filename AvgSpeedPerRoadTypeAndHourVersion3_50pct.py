...
def calcAvgSpeedFor50pct():
    path_enter = "/net/ils/mersini/input/v2024.2/Link_enter_50pct.csv"
    path_leave = "/net/ils/mersini/input/v2024.2/Link_leave_50pct.csv"
    path_Routes_with_arr_dep = "/net/ils/mersini/input/v2024.2/df_routes_dep_and_arr_50pct_case1.csv"
    
    res_case1 = calcAvgSpeedPerHourForRoadTypeSecTerRes(path_enter, path_leave, path_Routes_with_arr_dep,"50-pct", sample_nr= 1, alpha = 1.0, stuck_time=30.0, global_seed="default")
...
# 100 pct
result_50pct = calcAvgSpeedFor50pct()
output_path_50pct = path_part1 + "Avg_Speed_per_RoadTypeAndHour_50pct_from_df_routes.csv"
result_50pct.to_csv(output_path_50pct, index = False)
